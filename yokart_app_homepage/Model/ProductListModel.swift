...
struct Collection: Codable {
    ...
    enum CodingKeys: String, CodingKey {
        ...
        case brands, totBrands, shops, totShops
    }
}
...
// MARK: - Shop
struct Shop: Codable {
    let ctrDisplayOrder, shopID, shopUserID, shopName: String?
    let countryName, stateName, shopUpdatedOn: String?
    let shopAvgRating: String?
    let shopTotalReviews: String?
    let shopLogo: String?
    let shopBanner: String?
    let rating: String?

    enum CodingKeys: String, CodingKey {
        case ctrDisplayOrder = "ctr_display_order"
        case shopID = "shop_id"
        case shopUserID = "shop_user_id"
        case shopName = "shop_name"
        case countryName = "country_name"
        case stateName = "state_name"
        case shopUpdatedOn = "shop_updated_on"
        case shopAvgRating = "shop_avg_rating"
        case shopTotalReviews = "shop_total_reviews"
...
struct Product: Codable {
    ...
    let splpriceDisplayListPrice, splpriceDisplayDisVal: String?
